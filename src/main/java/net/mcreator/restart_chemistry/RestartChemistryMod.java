package net.mcreator.restart_chemistry;
...
@Mod("restart_chemistry")
public class RestartChemistryMod {
	public static final Logger LOGGER = LogManager.getLogger(RestartChemistryMod.class);
	public static final String MODID = "restart_chemistry";

	public RestartChemistryMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		RestartChemistryModSounds.REGISTRY.register(modEventBus);
		RestartChemistryModBlocks.REGISTRY.register(modEventBus);
		RestartChemistryModBlockEntities.REGISTRY.register(modEventBus);
		RestartChemistryModItems.REGISTRY.register(modEventBus);
		...
		RestartChemistryModFluidTypes.REGISTRY.register(modEventBus);

...
import net.mcreator.restart_chemistry.potion.ZhongduMobEffect;
...
public class RestartChemistryModMobEffects {
	...
	public static final DeferredHolder<MobEffect, MobEffect> ZHONGDU = REGISTRY.register("zhongdu", () -> new ZhongduMobEffect());
}

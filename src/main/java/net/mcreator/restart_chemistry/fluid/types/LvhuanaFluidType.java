...
public class LvhuanaFluidType extends FluidType {
	public LvhuanaFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("restart_chemistry:block/lvhuana-jing");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("restart_chemistry:block/lvhuana-dong");
		...
		}, RestartChemistryModFluidTypes.LVHUANA_TYPE.get());
	}
}
